...
def join_fba_targets(targets_file="./targets.fits", fba_path="./", summary_filename="fba_summary.fits", exclude_petal=-1, survey='main'):
    ...
    if survey=='main':
        ...
        types = {'isELG':sv3_targetmask.desi_mask['ELG'],
            'isLRG':sv3_targetmask.desi_mask['LRG'],
            'isQSO':sv3_targetmask.desi_mask['QSO'],
            'isBGS_ANY':sv3_targetmask.desi_mask['BGS_ANY'],
            'isMWS_ANY':sv3_targetmask.desi_mask['MWS_ANY']}
    ...
    for t, m in zip(types.keys(), types.values()):
        if survey=='main':
            ...
            ii = (targetdata['SV3_DESI_TARGET']&m)!=0
...
join_fba_targets(targets_file="inputs/mtl_bright_sv3_onepct.fits", 
                 fba_path="./fba_mtl_bright_sv3_onepct/", 
                 summary_filename="summary_fba_mtl_bright_sv3_onepct.fits", survey='sv3')


join_fba_targets(targets_file="inputs/mtl_updated_lya_0.20_dark_sv3_onepct.fits", 
                 fba_path="./fba_mtl_updated_lya_0.20_dark_sv3_onepct/", 
                 summary_filename="summary_fba_mtl_updated_lya_0.20_dark_sv3_onepct.fits", survey='sv3')
