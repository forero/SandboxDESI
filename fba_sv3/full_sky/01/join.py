...
join_fba_targets(targets_file="inputs/mtl_updated_lya_0.20_full_sky_dark_sv3.fits", 
                 fba_path="./fba_mtl_dark_full_sky/", 
                 summary_filename="summary_fba_mtl_updated_lya_0.20_full_sky_dark_sv3.fits", survey='sv3')


join_fba_targets(targets_file="inputs/mtl_full_sky_bright_sv3.fits", 
                 fba_path="./fba_mtl_bright_full_sky/", 
                 summary_filename="summary_fba_mtl_full_sky_bright_sv3.fits", survey='sv3')
