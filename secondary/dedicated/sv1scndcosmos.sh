...
python ~/fiberassign/bin/fba_sv1  --dr dr9 --dtver 0.51.0 --rundate 2020-01-01T00:00:00 --tilera 150.12  --tiledec 2.30  --tileid 82001  --faflavor sv1scndcosmos  --priority custom --noreobs ./sv1scndcosmos/fiberassign-082000.fits.gz --outdir ./sv1scndcosmos 
