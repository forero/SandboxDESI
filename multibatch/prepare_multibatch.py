...
patch_DR8_mtl_file_dark = make_patch_file(global_DR8_mtl_file_dark)
patch_DR8_mtl_file_bright = make_patch_file(global_DR8_mtl_file_bright)
patch_DR8_sky_file = make_patch_file(global_DR8_sky_file)
patch_DR8_truth_file_dark = make_patch_file(global_DR8_truth_file_dark)
patch_DR8_truth_file_bright = make_patch_file(global_DR8_truth_file_bright)


surveysim_file="/global/cfs/cdirs/desi/users/schlafly/surveysim/exposures_nopass7.fits"
#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_month', program='dark', start_day=0, end_day=365, batch_cadence=28) 
#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_month', program='bright', start_day=0, end_day=365, batch_cadence=28) 
#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_semester', program='dark', start_day=0, end_day=365, batch_cadence=180) 
#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_semester', program='bright', start_day=0, end_day=365, batch_cadence=180)

#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_patch_month', program='dark', 
#                                 start_day=0, end_day=2000, batch_cadence=28,select_subset_sky=True) 
#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_patch_month', program='bright', 
#                                 start_day=0, end_day=2000, batch_cadence=28, select_subset_sky=True) 
#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_patch_semester', program='dark', 
#                                 start_day=0, end_day=2000, batch_cadence=180, select_subset_sky=True) 
#n_batches = prepare_tile_batches(surveysim_file, output_path='footprint_patch_semester', program='bright', 
#                                 start_day=0, end_day=2000, batch_cadence=180, select_subset_sky=True)
#print(n_batches)    
