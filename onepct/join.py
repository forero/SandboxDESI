...
join_fba_targets(targets_file="targets/mtl_dark_onepct.fits", fba_path="./fba_output_all_dark/", summary_filename="fba_summary_all_dark.fits")
join_fba_targets(targets_file="targets/mtl_dark_onepct.fits", fba_path="./fba_output_single_dark/", summary_filename="fba_summary_single_dark.fits")