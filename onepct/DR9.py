...
def write_onepct_mtl(output_path="./", program='bright'):
    full_mtl_file = os.path.join(output_path, "mtl_{}_onepct.fits".format(program))
    ...
    # List all the fits files to read
    path_to_targets = '/global/cfs/cdirs/desi/target/catalogs/dr9/0.49.0/targets/main/resolve/'+program+'/'
